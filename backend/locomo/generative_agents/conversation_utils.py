...
- When sharing a photo, write the detailed caption of the photo between square brackets. For example, "Bachpan mein, meri mummy pineapple birthday cakes banati thi and I loved them.\n[shares an old photo of a pineapple birthday cake with a candle that says 1]"
...
CASUAL_DIALOG_PROMPT = "Make the sentence short, less formal, less grandiose and more casual. Use Hinglish (a mix of Hindi and English written in Roman script) like 'aap kya kr rhe ho' or 'm toh bhadiya hu'.\n\nInput: %s\nOutput: "
...
def get_images(query, out_dir, file_offset):
    if os.environ.get("LOCOMO_DISABLE_IMAGE_CRAWL", "0") == "1":
        return [], []
