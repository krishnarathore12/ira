...
from himem.embeddings.base import EmbeddingBase
...
class HuggingFaceEmbedding(EmbeddingBase):
    def __init__(self, config: Optional[BaseEmbedderConfig] = None):
        ...
        if config.base_url:
            ...
            self.embedding_dims = self.config.embedding_dims or self.model.get_sentence_embedding_dimension()

    def encode(self, text, memory_action: Optional[Literal["add", "search", "update"]] = None):
        """
