...
from himem.reranker.base import BaseReranker
...
class HuggingFaceReranker(BaseReranker):
    ...
    def rerank(self, query: str, documents: List[Dict[str, Any]], top_k: int = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if final_top_k:
                doc_score_pairs = doc_score_pairs[:int(final_top_k)]
            ...
            final_top_k = top_k or self.config.top_k
            return documents[:int(final_top_k)] if final_top_k else documents
